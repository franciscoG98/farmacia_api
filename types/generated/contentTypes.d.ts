...
export interface ApiOrdenOrden extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::orden.orden'> &
      Schema.Attribute.Private;
    ObraSocial: Schema.Attribute.String;
    productos: Schema.Attribute.Relation<
      'manyToMany',
      'api::producto.producto'
    >;
    publishedAt: Schema.Attribute.DateTime;
    Receta: Schema.Attribute.Boolean & Schema.Attribute.Required;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Nombre: Schema.Attribute.String & Schema.Attribute.Required;
    ordens: Schema.Attribute.Relation<'manyToMany', 'api::orden.orden'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    UserType: Schema.Attribute.Enumeration<['admin', 'customer', 'superuser']>;
  };
}
